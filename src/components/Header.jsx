    ...
    <header>
		...
		<nav className="container flex items-center justify-between space-x-10 py-6">
			...
			<ul className="flex items-center space-x-5">
				...
				<li>
					<a className="bg-primary/20 dark:bg-primary/[7%] rounded-lg backdrop-blur-[2px] p-1 inline-block" href="#" onClick={handleCartOpen}>
						<img src={shoppingcart} width="24" height="24" alt="" />
						{addCartMovieDetails.length>0 && <span className="rounded-full absolute top-[-12px] left-[28px] bg-[#12CF6F] text-white text-center p-[2px] w-[30px] h-[30px]">
