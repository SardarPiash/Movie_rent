...
export default function MovieModal({ onCloseModal, Movie }) {
  return (
    <div className="fixed top-0 left-0 w-screen h-screen z-50 bg-white/60 backdrop-blur-sm">
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[420px] sm:max-w-[600px] lg:max-w-[984px] p-4 max-h-[90vh] overflow-auto">
        <div className="bg-white shadow-md dark:bg-[#f4f4f8] rounded-2xl sm:grid sm:grid-cols-[2fr_1fr] overflow-hidden">
          <img
          ...
          <div className="p-5 lg:p-11">
            <div className="">
              ...
              <span className="block text-base text-[#9fa0a4] dark:text-[#080808] my-3">
                {Movie.genre}
              </span>
              <div></div>
            </div>
